...
# Lista de subpastas específicas baseadas no prefixo do nome do arquivo
prefixos_pastas = {
    "dorpicomuni": "dorpicomuni",
    "dorpictrtec": "dorpictrtec",
    "dorpidesind": "dorpidesind",
    "dorpiindgeo": "dorpiindgeo",
    "dorpimarcas": "dorpimarcas",
    "dorpipatentes": "dorpipatentes",
    "dorpiprocomp": "dorpiprocomp",
    "dorpitopci": "dorpitopci",
}
...
def mover_arquivo_para_diretorio(origem_dir, base_dir):
    ...
    for file_name in arquivos:
        ...
        # Identifica o prefixo correspondente no nome do arquivo
        prefixo = next((key for key in prefixos_pastas if file_name_without_ext.startswith(key)), None)
        if not prefixo:
            print(f"Erro: O arquivo '{file_name}' não corresponde a nenhum prefixo conhecido.")
            continue
        ...
        subfolder = prefixos_pastas[prefixo]
